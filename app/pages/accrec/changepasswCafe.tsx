...
import { editPasswCafe } from '@/services/accounts';

export default function ChangePasswCafePage() {
  ...
  const handlePost = async (
    ...
    const handler = await editPasswCafe({
      code,
      senha,
      email,
      rnewpassw,
    ...
    if (handler.response === true) {
      return routers.replace('/pages/login/LoginCafe');
    }
